...
<h1>Show Teams</h1>
<a href="{{route('team.create')}}"><button>Add Team </button></a>
<a href="{{route('usershow')}}"><button>User Visible Team </button></a>
...
@if(count($teams) > 0)
    ...
    @endif
                    ...
                    <td>
                      <a href="{{ route('teams.edit', $team->id) }}"><button>Update</button></a>
                      <a href="{{route('teams.delete',$team->id)}}"><button>Delete</button></a>
                    </td>
                </tr>
            @endforeach
        </tbody>
