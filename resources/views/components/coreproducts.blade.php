<div class="group relative flex w-[350px] " data-aos="flip-left"
    ...
    <div class=" absolute inset-0 flex items-end justify-end text-white bg-black bg-opacity-40 opacity-0 group-hover:opacity-100 transition-opacity hover:cursor-pointer w-[350px] rounded-3xl text-3xl font-bold p-5">
        {{$coreproducts}}
    </div>
</div>
