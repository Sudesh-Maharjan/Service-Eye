<div class="banner h-1/2 flex items-center justify-center flex-col" >
    ...
    <div class="banner-content max-w-90 flex items-center ">
            <div class="text-content flex-1 p-20 h-[500px]">
                ...
                <br>
                <button class="btn btn-md border border-black py-1 px-2 hover:bg-black hover:text-white rounded-md p-3">Join Us</button>
                <br>
                <br>
                <h6 class="text-md">Watch Our JOURNEY</h6>
            </div>
            <div class="image-content flex-1 justify-center">
