        ...
        <div class="flex flex-col md:flex-row gap-20 justify-center items-center ">
            <div class="w-full md:w-2/5 lg:w-2/6 bg-sky-950 bg-opacity-75 rounded py-8">
                <form class="max-w-sm mx-auto" action=" {{route('postcontactus')}}">
                    ...
                    <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Send
                        Message</button>
                </form>
            </div>
