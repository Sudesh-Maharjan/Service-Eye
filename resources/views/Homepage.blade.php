...
<body>
   ...
   <x-happyusers title="User" emoji="<i class='fa-regular fa-face-smile '></i>" numbers="80"  class="animated-number"  data-target="80"/>
   <x-happyusers title="Projects" emoji="<i class='fa-solid fa-bullseye'></i>" numbers="150"  class="animated-number"  data-target="150"/>
...
<x-heading heading="Our Core Products"/>
        ...
        <div class="mt-4 font-bold text-xl text-center">
            <p>"Revolutions your workflow with our cutting edge IT product, seamlessly integrating innovative technology to enhance efficiency, security and user experience."
